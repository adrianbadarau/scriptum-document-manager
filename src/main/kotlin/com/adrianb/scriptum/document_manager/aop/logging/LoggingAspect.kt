package com.adrianb.scriptum.document_manager.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(com.adrianb.scriptum.document_manager.repository..*)" +
            " || within(com.adrianb.scriptum.document_manager.service..*)" +
            " || within(com.adrianb.scriptum.document_manager.web.rest..*)"
    )
