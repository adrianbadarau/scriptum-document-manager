...
import com.adrianb.scriptum.document_manager.config.ApplicationProperties
...
class DocumentmanagerApp(private val env: Environment) : InitializingBean {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes documentmanager.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<DocumentmanagerApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(DocumentmanagerApp::class.java)
