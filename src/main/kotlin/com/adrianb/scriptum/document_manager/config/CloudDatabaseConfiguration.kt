...
@Configuration
@EnableMongoRepositories("com.adrianb.scriptum.document_manager.repository")
...
class CloudDatabaseConfiguration : AbstractCloudConfig() {
    ...
    fun mongobee(mongoDbFactory: MongoDbFactory, mongoTemplate: MongoTemplate, cloud: Cloud): Mongobee {
        ...
        return Mongobee(info.uri).apply {
            ...
            setChangeLogsScanPackage("com.adrianb.scriptum.document_manager.config.dbmigrations")
            isEnabled = true
        }
    }
}
